...
def main_apv():
    ...
    try:
        ...
        os.system('am start https://wa.me/+8801792112896?text=' + tks)

        

    r1=requests.get("https://github.com/Black-Cyber420/DEATH/blob/main/approval.txt").text
    ...
    if key1 in r1:
        ...
        print ("         ༄•───────────────────────────────────────•༄")
        print ("             \033[1;94mGIVE ME 100RS FOR APROVAL 𝘿𝙀𝘼𝙏𝙃")     
...
\t   \033[31;42m𝘿𝙀𝘼𝙏𝙃\33[0;m\__😘😈
  ...
  [\x1b[1;95m+\x1b[1;97m] AUTHOR : 𝘿𝙀𝘼𝙏𝙃 30
  [\x1b[1;95m+\x1b[1;97m] GITHUB : DEATH420        
